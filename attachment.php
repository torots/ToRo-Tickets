...
/*********************************************************************
    ...
    $Id: attachment.php,v 1.1 2011/08/20 13:51:56 ntozier Exp $
**********************************************************************/
require('secure.inc.php');
//TODO: alert admin on any error on this file.
if(!$thisclient || !$thisclient->isClient() || !$_GET['id'] || !$_GET['ref']) die(translate("TEXT_ACCESS_DENIED"));
