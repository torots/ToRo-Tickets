...
/*********************************************************************
    ...
    $Id: profile.php,v 1.1 2011/10/21 13:42:46 root Exp $
**********************************************************************/
...
$nav->addSubMenu(array('desc'=>translate("LABEL_MY_PROFILE"),'href'=>'profile.php','iconclass'=>'user'));
$nav->addSubMenu(array('desc'=>translate("LABEL_PREFERENCES"),'href'=>'profile.php?t=pref','iconclass'=>'userPref'));
$nav->addSubMenu(array('desc'=>translate("LABEL_CHANGE_PASSWORD"),'href'=>'profile.php?t=passwd','iconclass'=>'userPasswd'));

//Warnings if any.
if($thisuser->onVacation()){
        $warn.=translate("TEXT_WELCOME_BACK_VACATION");
}
...
if($thisuser->forcePasswdChange()){
    $errors['err']=translate("ERROR_YOU_MUST_CHANGE_PASSWORD");
    $inc='changepasswd.inc.php';
}
