...
/*********************************************************************
    ...
    $Id: attachment.php,v 1.1 2011/08/20 14:27:06 ntozier Exp $
**********************************************************************/
require('staff.inc.php');
//TODO: alert admin on any error on this file.
if(!$thisuser || !$thisuser->isStaff() || !$_GET['id'] || !$_GET['ref']) die(translate("TEXT_ACCESS_DENIED"));
...
if(!$_GET['ref'] || strcmp($hash,$_GET['ref'])) die(translate("TEXT_ACCESS_DENIED"));
//Check ticket access,
