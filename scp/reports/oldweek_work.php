...
<? 
$sunday2 = date(('Y-m-d H:i:s'), strtotime('last sunday 09:00'));
$sunday1 = date(('Y-m-d H:i:s'), strtotime('2 weeks ago 09:00'));

$query = "SELECT DISTINCT(ost_ticket.ticket_id) as ticket,ost_ticket.agency as agency,ost_ticket.closed as closed,ost_ticket_response.ticket_id 
 FROM ost_ticket,ost_ticket_response 
 WHERE (ost_ticket_response.staff_name = '$staffname' AND ost_ticket.ticket_id = ost_ticket_response.ticket_id) 
 AND ((ost_ticket.created BETWEEN '$sunday1' and '$sunday2') 
 OR (ost_ticket_response.created BETWEEN '$sunday1' and '$sunday2') 
 OR (ost_ticket.updated BETWEEN '$sunday1' and '$sunday2') 
 OR (ost_ticket.closed BETWEEN '$sunday1' and '$sunday2'))
 ORDER BY ost_ticket.created ASC;";
