...
/*********************************************************************
    ...
    $Id: kb.php,v 1.2 2011/10/24 20:58:53 root Exp $
**********************************************************************/

require('staff.inc.php');
if(!$thisuser->canManageKb() && !$thisuser->isadmin()) die(translate("TEXT_ACCESS_DENIED"));
...
$nav->addSubMenu(array('desc'=>translate("LABEL_PREMADE_REPLIES"),'href'=>'kb.php','iconclass'=>'premade'));
$nav->addSubMenu(array('desc'=>translate("LABEL_NEW_PREMADE_REPLY"),'href'=>'kb.php?a=add','iconclass'=>'newPremade'));
