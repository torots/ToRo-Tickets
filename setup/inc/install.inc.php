...
if(!isset($info['title'])) {
    $info['title']='ToRo Ticketing System';
}
...
<table width="100%" cellspacing="0" cellpadding="2" class="setup">
	<!-- (issue 6) -->
    <tr class="title"><td colspan=2>ToRo web path and title</td></tr>
    <tr class="subtitle"><td colspan=2>Url to ToRo installation on your server and the title.</td></tr>
