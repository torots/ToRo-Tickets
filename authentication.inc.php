...
<table width="100%" border="0" cellspacing=0 cellpadding=0>
 <tr>
  ...
  <tr><th><?php te('LABEL_AUTHENTICATION')?></th></tr>
  <tr><td>
...
<table>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;server name:</td>
  <td><input id="ldap" type="text" name="ldapserver" value="<?php if(($auth_type==2)&&($auth_data)) { echo $auth_data; } ?>"/></td>
 </tr>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;server port:</td>
  <td><input id="ldap" type="text" name="ldapport" value="<?php if(($auth_type==2)&&($auth_data)) { echo $auth_port; } ?>"/></td>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Base DN:</td>
  <td><input id="ldap" type="text" name="ldapdn" value="<?php if(($auth_type==2)&&($auth_data)) { echo $auth_dn; } ?>"/></td>
 </tr>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LDAP Version:</td>
  <td><input id="ldap" type="text" name="ldapver" value="<?php if(($auth_type==2)&&($auth_data)) { echo $auth_ver; } ?>"/></td>
 </tr>
 <tr>
