...
<form action="admin.php?t=syslog" method="POST" name='syslog' onSubmit="return checkbox_checker(this,1,0);">
    ...
    <tr>
        <td style="padding-left:20px">
            Select:&nbsp;
            <a href="#" onclick="return select_all(document.forms['syslog'],true)">All</a>&nbsp;
            <a href="#" onclick="return reset_all(document.forms['syslog'])">None</a>&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['syslog'],true)">Toggle</a>&nbsp;
        </td>
    </tr>
    <tr>
        <td align="center">
            <input class="button" type="submit" name="delete" value="Delete Selected Log Record" 
