<? if(!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff() || !is_object($nav)) die(translate("TEXT_ACCESS_DENIED")); 
?>
...
<div id="container">
    <div id="header">
        ...
        <p id="info"><?php print translate('TEXT_WELCOME_BACK_STAFF'); ?> 
           <?php
            if($thisuser->isAdmin() && !defined('ADMINPAGE')) { ?>
            | <a href="admin.php"><?php print translate('LABEL_ADMIN_PANEL');?></a> 
            <?}else{?>
            | <a href="index.php"><?php print translate('LABEL_STAFF_PANEL');?></a>
            <?}?>
