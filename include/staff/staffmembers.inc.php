...
$showing=($num=db_num_rows($users))?translate("LABEL_STAFF_MEMBERS"):translate('NO_STAFF_FOUND'). " <a href='admin.php?t=staff&a=new&dept=$id'>Add New User</a>.";        
?>
 ...
 <table width="100%" border="0" cellspacing=1 cellpadding=2>
    ...
    <tr><td>
     <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        <th width="7px">&nbsp;</th>
	    <th><?php print translate("LABEL_FULL_NAME");?></th>
            ...
            <th><?php print translate("LAST_LOGIN");?></th>
        </tr>
        <?
        $class = 'row1';
        $total=0;
    ...
    <tr><td>
        <div style="margin-left:20px;">
            ...
            <a href="#" onclick="return select_all(document.forms['staff'],true)"><?php print translate("LABEL_ALL");?></a>&nbsp;&nbsp;
            <a href="#" onclick="return toogle_all(document.forms['staff'],true)"><?php print translate("LABEL_TOGGLE");?></a>&nbsp;&nbsp;
            <a href="#" onclick="return reset_all(document.forms['staff'])"><?php print translate("LABEL_NONE");?></a>&nbsp;&nbsp;
        </div>
    </td></tr>
    <tr><td align="center">
        ...
        <input class="button" type="submit" name="disable" value='<?php print translate("LOCK");?>' 
