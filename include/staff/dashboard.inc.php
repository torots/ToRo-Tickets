...
<table>
 ...
 <tr>
  <td valign=top>
   <?php print translate("AVG_OPEN_TIME");?>:<br><ul>
   <?
   ...
   <?php print translate("AVG_RESPONSE_TIME");?>:<br><ul>
    <?
   ...
   <?php print translate("NUMBER_OF_TICKETS_OPENED");?>:<br><ul>
   <?
  ...
  <td width=450 valign=top>
   ...
   <fieldset style="border: 1px solid #000000;">
    <legend><?php print translate("TEXT_CLIENT_MESSAGE_OF_THE_DAY");?></legend>
     <?php 
   ...
   <br>
   <fieldset style="border: 1px solid #000000;">
    <legend><?php print translate("TEXT_STAFF_MESSAGE_OF_THE_DAY");?></legend>
     <?php
      //$query = "SELECT motd,motd_lastupdated FROM toro_config";
   ...
   <fieldset style="border: 1px solid #000000;">
    <legend><?php print translate("TEXT_LAST_5_LOG_ENTRIES");?>:</legend>
     <table cellspacing=0 cellpadding=0><tr bgcolor=#CCE3F3>
      <th>&nbsp;&nbsp;&nbsp; <?php print translate("LABEL_ID");?></th><th>&nbsp; &nbsp;</th><th><?php print translate("LABEL_TYPE");?></th><th>&nbsp; &nbsp;</th>
      <th><?php print translate("TITLE");?></th><th>&nbsp; &nbsp;</th><th><?php print translate("TEXT_CREATED");?></th><th>&nbsp; &nbsp;</th></tr>
    <?php
