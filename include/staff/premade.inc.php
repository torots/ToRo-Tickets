<?php
if(!defined('OSTSCPINC') or !is_object($thisuser) or !$thisuser->canManageKb()) die(print translate("TEXT_ACCESS_DENIED"));
...
<div align="left">
    ...
    <?php print translate('LABEL_CATEGORY')?>
    <select name="dept">
...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
   ...
   <tr><td>
     <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        <th width="7px">&nbsp;</th>
	        <th>
                <a href="kb.php?sort=title&order=<?=$negorder?><?=$qstr?>" title="<?php print translate('LABEL_SORT_BY_TITLE') ?> <?=$negorder?>"><?php print translate('LABEL_REPLY_TITLE') ?></a></th>
            <th width=50><?php print translate('LABEL_STATUS') ?></th>
	        <th width=200><?php print translate('LABEL_CATEGORY_DEPT') ?></th> 
	        <th width=150 nowrap>
                <a href="kb.php?sort=updatedate&order=<?=$negorder?><?=$qstr?>" title="<?php print translate('LABEL_SORT_BY_UPDATE_DATE') ?> <?=$negorder?>"><?php print translate('LABEL_UPDATE_DATE')?></a></th>
        </tr>
        <?
        $class = 'row1';
        $total=0;
        ...
        if($replies && db_num_rows($replies)):
            ...
            <tr class="<?=$class?>" id="<?=$row['premade_id']?>">
                ...
                <td><?=$row['dept_name']?Format::htmlchars($row['dept_name']):translate('LABEL_ALL_DEPARTMENTS')?></td>
            ...
            <tr class="<?=$class?>"><td colspan=6><b><?php print translate('LABEL_QUERY_RETURNED_ZERO_RESULT')?></b></td></tr>
        <?
        endif; ?>
    </table>
   </td></tr>
   ...
   <tr><td style="padding-left:20px">
        ...
        <a href="#" onclick="return select_all(document.forms['premade'],true)"><?php print translate('LABEL_ALL')?></a>&nbsp;
        <a href="#" onclick="return toogle_all(document.forms['premade'],true)"><?php print translate('LABEL_TOGGLE')?></a>&nbsp;
        <a href="#" onclick="return reset_all(document.forms['premade'])"><?php print translate('LABEL_NONE')?></a>&nbsp;
