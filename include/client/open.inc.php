...
<div><?php echo translate('TEXT_PLEASE_FILL_FORM_NEW_TICKET')?></div><br>
<form action="open.php" method="POST" enctype="multipart/form-data">
<table align="left" cellpadding=2 cellspacing=1 width="90%">
    <tr>
        <th width="20%"><?php echo translate('LABEL_FULL_NAME')?>:</th>
        <td>
    ...
    <tr>
        <th nowrap ><?php echo translate('LABEL_EMAIL_ADDRESS')?>:</th>
        <td>
            ...
            <?if ($thisclient && ($name=$thisclient->getName())) { ?>
            	<br>
				<A href="logout.php" ><?php echo translate('TEXT_NOT_THIS_USER')?></A>
			<?}?>
        </td>
    </tr>
    <tr>
        <td><?php echo translate('LABEL_TELEPHONE'); ?>:</td>
    ...
    <tr>
        <th><?php echo translate('LABEL_HELP_TOPIC'); ?>:</th>
        <td>
            <select name="topicId">
                <option value="" selected ><?php translate('LABEL_SELECT_ONE_TOPIC') ?></option>
                <?
                ...
                <?php /*<option value="0" ><?php echo translate('TEXT_GENERAL_INQUIRY');?></option> */ ?>
            </select>
            &nbsp;<font class="error">*&nbsp;<?php echo $errors['topicId']?></font>
        </td>
    </tr>
    <tr>
        <th><?php echo translate('LABEL_SUBJECT')?>:</th>
        <td>
    ...
    <tr>
        <th valign="top"><?php echo translate('LABEL_MESSAGE')?>:</th>
        <td>
    ...
    if($cfg->allowPriorityChange() ) {
      ...
      <tr>
        <td><?php echo translate('LABEL_PRIORITY')?>:</td>
        <td>
            <select name="pri">
              <?
    ...
    <?if(($cfg->allowOnlineAttachments() && !$cfg->allowAttachmentsOnlogin())  
        ...
        ?>
    <tr>
        <td><?php echo translate('LABEL_ATTACHMENT')?>:</td>
        <td>
    ...
    <tr>
        <td></td>
        <td>
            <input class="button" type="submit" name="submit_x" value="<?php echo translate('LABEL_SUBMIT_TICKET')?>">
            <input class="button" type="reset" value="<?php echo translate('LABEL_RESET')?>">
            <input class="button" type="button" name="cancel" value="<?php echo translate('LABEL_CANCEL')?>" onClick='window.location.href="index.php"'>    
        </td>
    </tr>
</table>
</form>
