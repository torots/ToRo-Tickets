...
<table width="100%" border="0" cellspacing=0 cellpadding=0>
 ...
 <tr><td>
	...
	<tr><th>Can <b>Mass</b> Ban & Delete Emails</th>
	    <td>
	        <input type="radio" name="can_mass_ban_emails"  value="1" <?=$info['can_mass_ban_emails']?'checked':''?> />Yes
                <input type="radio" name="can_mass_ban_emails"  value="0" <?=!$info['can_mass_ban_emails']?'checked':''?> />No
                &nbsp;&nbsp;<i>Ability to ban & delete emails en masse from tickets view (Spam).</i>
            </td>
        </tr>
